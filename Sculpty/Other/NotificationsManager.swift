...
class NotificationManager {
    ...
    func cancelTodaysCalorieReminder() {
        ...
        let identifier = "sculpty-daily-calorie-reminder-\(today.year!)-\(today.month!)-\(today.day!)"
    ...
    private func scheduleWeeklyMeasurementReminders() {
        if CloudSettings.shared.enableMeasurementsNotifications {
            ...
            let request = UNNotificationRequest(identifier: "sculpty-weekly-measurement", content: content, trigger: trigger)
    ...
    private func scheduleDailyCalorieReminders() {
        if CloudSettings.shared.enableCaloriesNotifications {
            ...
            for i in 0..<30 {
                ...
                let identifier = "sculpty-daily-calorie-reminder-\(dateComponents.year!)-\(dateComponents.month!)-\(dateComponents.day!)"
